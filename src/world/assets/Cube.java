...
public class Cube extends RenderableEntity {
    int sideLength;
    ...
    public void createCube() {
        ...
        Mesh frontFace = new Mesh(this, new Coordinate[]{vertex1, vertex2, vertex3, vertex4}, StdDraw.RED);
        Mesh topFace = new Mesh(this, new Coordinate[]{vertex2, vertex6, vertex7, vertex3}, StdDraw.BLUE);
        Mesh bottomFace = new Mesh(this, new Coordinate[]{vertex1, vertex5, vertex8, vertex4}, StdDraw.GREEN);
        Mesh backFace = new Mesh(this, new Coordinate[]{vertex5, vertex6, vertex7, vertex8}, StdDraw.YELLOW);
        Mesh leftFace = new Mesh(this, new Coordinate[]{vertex1, vertex2, vertex6, vertex5}, StdDraw.ORANGE);
        Mesh rightFace = new Mesh(this, new Coordinate[]{vertex4, vertex3, vertex7, vertex8}, StdDraw.WHITE);
