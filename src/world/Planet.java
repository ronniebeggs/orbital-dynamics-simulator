...
public class Planet extends Satellite {
    ...
    public Color color;
    public Planet(Satellite parent, int mass, double x, double y, double xVelocity, double yVelocity, double orbitalRadius, double orbitalVelocity, double trueAnomaly) {
